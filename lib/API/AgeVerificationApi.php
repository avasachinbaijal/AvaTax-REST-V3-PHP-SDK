...
class AgeVerificationApi
{
    ...
    public function verifyAgeRequest($age_verify_request, $simulated_failure_code = null)
    {
        ...
        $clientId="{$this->client->config->getAppName()}; {$this->client->config->getAppVersion()}; PhpRestClient; 2.3.7; {$this->client->config->getMachineName()}";
