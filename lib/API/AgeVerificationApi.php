...
class AgeVerificationApi
{
    ...
    private function setConfiguration($client): void
    {
        ...
        $client->setSdkVersion("2.4.22-beta");
    ...
    public function verifyAgeRequest($age_verify_request, $simulated_failure_code = null)
    {
        ...
        $clientId="{$this->client->config->getAppName()}; {$this->client->config->getAppVersion()}; PhpRestClient; 2.4.22-beta; {$this->client->config->getMachineName()}";
