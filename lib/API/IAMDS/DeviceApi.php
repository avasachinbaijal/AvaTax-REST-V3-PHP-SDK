...
class DeviceApi
{
     ...
     * @return void
     */
    public function addGrantToDevice($device_id, $grant_id, $avalara_version = null, $x_correlation_id = null)
    {
        $this->addGrantToDeviceWithHttpInfo($device_id, $grant_id, $avalara_version, $x_correlation_id);
    }

    /**
     * Operation addGrantToDeviceWithHttpInfo
     *
     * Add a grant to a device.
     *
    ...
    /**
     * Operation addGrantToDeviceAsync
     *
     * Add a grant to a device.
     *
     * @param  string $device_id (required)
     ...
     */
    public function addGrantToDeviceAsync($device_id, $grant_id, $avalara_version = null, $x_correlation_id = null)
    {
        return $this->addGrantToDeviceAsyncWithHttpInfo($device_id, $grant_id, $avalara_version, $x_correlation_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addGrantToDeviceAsyncWithHttpInfo
     *
     * Add a grant to a device.
     *
     * @param  string $device_id (required)
    ...
    /**
     * Create request for operation 'addGrantToDevice'
     *
     * @param  string $device_id (required)
     * @param  string $grant_id (required)
     * @param  string $avalara_version States the version of the API to use. (optional)
     ...
     */
    public function addGrantToDeviceRequest($device_id, $grant_id, $avalara_version = null, $x_correlation_id = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
        ...
        if ($device_id === null || (is_array($device_id) && count($device_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $device_id when calling addGrantToDevice'
            );
        }
        // verify the required parameter 'grant_id' is set
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $grant_id when calling addGrantToDevice'
            );
        }

        $resourcePath = '/devices/{device-id}/grants/{grant-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $avalara_version States the version of the API to use. (optional)
     * @param  string $x_correlation_id Correlation ID to pass into the method. Returned in any response. (optional)
     * @param  \Avalara\SDK\Model\IAMDS\Device $device device (optional)
     *
     * @throws \Avalara\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Avalara\SDK\Model\IAMDS\Device|\Avalara\SDK\Model\IAMDS\VersionError
     */
    public function createDevice($avalara_version = null, $x_correlation_id = null, $device = null)
    {
        list($response) = $this->createDeviceWithHttpInfo($avalara_version, $x_correlation_id, $device);
        return $response;
    }
     ...
     * @param  string $avalara_version States the version of the API to use. (optional)
     * @param  string $x_correlation_id Correlation ID to pass into the method. Returned in any response. (optional)
     * @param  \Avalara\SDK\Model\IAMDS\Device $device (optional)
     *
     * @throws \Avalara\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function createDeviceWithHttpInfo($avalara_version = null, $x_correlation_id = null, $device = null, $isRetry = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Avalara\SDK\Model\IAMDS\Device' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Avalara\SDK\Model\IAMDS\Device', []),
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Avalara\SDK\Model\IAMDS\Device',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDeviceAsync($avalara_version = null, $x_correlation_id = null, $device = null)
    {
        return $this->createDeviceAsyncWithHttpInfo($avalara_version, $x_correlation_id, $device)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createDeviceRequest($avalara_version = null, $x_correlation_id = null, $device = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
     ...
     * @return void
     */
    public function deleteDevice($device_id, $avalara_version = null, $x_correlation_id = null, $if_match = null)
    {
        $this->deleteDeviceWithHttpInfo($device_id, $avalara_version, $x_correlation_id, $if_match);
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDeviceAsync($device_id, $avalara_version = null, $x_correlation_id = null, $if_match = null)
    {
        return $this->deleteDeviceAsyncWithHttpInfo($device_id, $avalara_version, $x_correlation_id, $if_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteDeviceRequest($device_id, $avalara_version = null, $x_correlation_id = null, $if_match = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
        // verify the required parameter 'device_id' is set
        if ($device_id === null || (is_array($device_id) && count($device_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $device_id when calling deleteDevice'
            );
        }

        $resourcePath = '/devices/{device-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Avalara\SDK\Model\IAMDS\Device|\Avalara\SDK\Model\IAMDS\VersionError
     */
    public function getDevice($device_id, $avalara_version = null, $x_correlation_id = null, $if_none_match = null)
    {
        list($response) = $this->getDeviceWithHttpInfo($device_id, $avalara_version, $x_correlation_id, $if_none_match);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDeviceAsync($device_id, $avalara_version = null, $x_correlation_id = null, $if_none_match = null)
    {
        return $this->getDeviceAsyncWithHttpInfo($device_id, $avalara_version, $x_correlation_id, $if_none_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDeviceRequest($device_id, $avalara_version = null, $x_correlation_id = null, $if_none_match = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
        // verify the required parameter 'device_id' is set
     ...
     */
    public function getDeviceGroups($device_id, $filter = null, $top = null, $skip = null, $order_by = null, $count = null, $count_only = null, $avalara_version = null, $x_correlation_id = null)
    {
        list($response) = $this->getDeviceGroupsWithHttpInfo($device_id, $filter, $top, $skip, $order_by, $count, $count_only, $avalara_version, $x_correlation_id);
        return $response;
    }

    /**
     * Operation getDeviceGroupsWithHttpInfo
     *
     * List all groups for the device.
     *
     * @param  string $device_id (required)
    ...
    /**
     * Operation getDeviceGroupsAsync
     *
     * List all groups for the device.
     *
     * @param  string $device_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDeviceGroupsAsync($device_id, $filter = null, $top = null, $skip = null, $order_by = null, $count = null, $count_only = null, $avalara_version = null, $x_correlation_id = null)
    {
        return $this->getDeviceGroupsAsyncWithHttpInfo($device_id, $filter, $top, $skip, $order_by, $count, $count_only, $avalara_version, $x_correlation_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDeviceGroupsAsyncWithHttpInfo
     *
     * List all groups for the device.
     *
     * @param  string $device_id (required)
    ...
    /**
     * Create request for operation 'getDeviceGroups'
     *
     * @param  string $device_id (required)
     * @param  string $filter A filter statement to identify specific records to retrieve. (optional)
     * @param  string $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDeviceGroupsRequest($device_id, $filter = null, $top = null, $skip = null, $order_by = null, $count = null, $count_only = null, $avalara_version = null, $x_correlation_id = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
        // verify the required parameter 'device_id' is set
        if ($device_id === null || (is_array($device_id) && count($device_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $device_id when calling getDeviceGroups'
            );
        }

        $resourcePath = '/devices/{device-id}/groups';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function listDeviceGrants($device_id, $filter = null, $top = null, $skip = null, $order_by = null, $count = null, $count_only = null, $avalara_version = null, $x_correlation_id = null)
    {
        list($response) = $this->listDeviceGrantsWithHttpInfo($device_id, $filter, $top, $skip, $order_by, $count, $count_only, $avalara_version, $x_correlation_id);
        return $response;
    }

    /**
     * Operation listDeviceGrantsWithHttpInfo
     *
     * List all grants for the device.
     *
     * @param  string $device_id (required)
    ...
    /**
     * Operation listDeviceGrantsAsync
     *
     * List all grants for the device.
     *
     * @param  string $device_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listDeviceGrantsAsync($device_id, $filter = null, $top = null, $skip = null, $order_by = null, $count = null, $count_only = null, $avalara_version = null, $x_correlation_id = null)
    {
        return $this->listDeviceGrantsAsyncWithHttpInfo($device_id, $filter, $top, $skip, $order_by, $count, $count_only, $avalara_version, $x_correlation_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listDeviceGrantsAsyncWithHttpInfo
     *
     * List all grants for the device.
     *
     * @param  string $device_id (required)
    ...
    /**
     * Create request for operation 'listDeviceGrants'
     *
     * @param  string $device_id (required)
     * @param  string $filter A filter statement to identify specific records to retrieve. (optional)
     * @param  string $top If nonzero, return no more than this number of results.  Used with &#x60;$skip&#x60; to provide pagination for large datasets.  Unless otherwise specified, the maximum number of records that can be returned from an API call is 1,000 records. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listDeviceGrantsRequest($device_id, $filter = null, $top = null, $skip = null, $order_by = null, $count = null, $count_only = null, $avalara_version = null, $x_correlation_id = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
        // verify the required parameter 'device_id' is set
        if ($device_id === null || (is_array($device_id) && count($device_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $device_id when calling listDeviceGrants'
            );
        }

        $resourcePath = '/devices/{device-id}/grants';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Avalara\SDK\Model\IAMDS\DeviceList|\Avalara\SDK\Model\IAMDS\VersionError
     */
    public function listDevices($filter = null, $top = null, $skip = null, $order_by = null, $count = null, $count_only = null, $avalara_version = null, $x_correlation_id = null)
    {
        list($response) = $this->listDevicesWithHttpInfo($filter, $top, $skip, $order_by, $count, $count_only, $avalara_version, $x_correlation_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listDevicesAsync($filter = null, $top = null, $skip = null, $order_by = null, $count = null, $count_only = null, $avalara_version = null, $x_correlation_id = null)
    {
        return $this->listDevicesAsyncWithHttpInfo($filter, $top, $skip, $order_by, $count, $count_only, $avalara_version, $x_correlation_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listDevicesRequest($filter = null, $top = null, $skip = null, $order_by = null, $count = null, $count_only = null, $avalara_version = null, $x_correlation_id = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
     ...
     * @return void
     */
    public function patchDevice($device_id, $avalara_version = null, $x_correlation_id = null, $if_match = null, $device = null)
    {
        $this->patchDeviceWithHttpInfo($device_id, $avalara_version, $x_correlation_id, $if_match, $device);
    }

    /**
     * Operation patchDeviceWithHttpInfo
     *
     * Update only the fields in the body for the device.
     *
     * @param  string $device_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchDeviceAsync($device_id, $avalara_version = null, $x_correlation_id = null, $if_match = null, $device = null)
    {
        return $this->patchDeviceAsyncWithHttpInfo($device_id, $avalara_version, $x_correlation_id, $if_match, $device)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation patchDeviceAsyncWithHttpInfo
     *
     * Update only the fields in the body for the device.
     *
     * @param  string $device_id (required)
    ...
    /**
     * Create request for operation 'patchDevice'
     *
     * @param  string $device_id (required)
     * @param  string $avalara_version States the version of the API to use. (optional)
     * @param  string $x_correlation_id Correlation ID to pass into the method. Returned in any response. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchDeviceRequest($device_id, $avalara_version = null, $x_correlation_id = null, $if_match = null, $device = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
        // verify the required parameter 'device_id' is set
        if ($device_id === null || (is_array($device_id) && count($device_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $device_id when calling patchDevice'
            );
        }
    ...
    /**
     * Operation removeGrantFromDevice
     *
     ...
     * @return void
     */
    public function removeGrantFromDevice($device_id, $grant_id, $avalara_version = null, $x_correlation_id = null)
    {
        $this->removeGrantFromDeviceWithHttpInfo($device_id, $grant_id, $avalara_version, $x_correlation_id);
    }

    /**
     * Operation removeGrantFromDeviceWithHttpInfo
     *
     * Remove a grant from a device.
     *
     * @param  string $device_id (required)
    ...
    /**
     * Operation removeGrantFromDeviceAsync
     *
     * Remove a grant from a device.
     *
     * @param  string $device_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeGrantFromDeviceAsync($device_id, $grant_id, $avalara_version = null, $x_correlation_id = null)
    {
        return $this->removeGrantFromDeviceAsyncWithHttpInfo($device_id, $grant_id, $avalara_version, $x_correlation_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation removeGrantFromDeviceAsyncWithHttpInfo
     *
     * Remove a grant from a device.
     *
     * @param  string $device_id (required)
    ...
    /**
     * Create request for operation 'removeGrantFromDevice'
     *
     * @param  string $device_id (required)
     * @param  string $grant_id (required)
     * @param  string $avalara_version States the version of the API to use. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function removeGrantFromDeviceRequest($device_id, $grant_id, $avalara_version = null, $x_correlation_id = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
        // verify the required parameter 'device_id' is set
        if ($device_id === null || (is_array($device_id) && count($device_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $device_id when calling removeGrantFromDevice'
            );
        }
        // verify the required parameter 'grant_id' is set
        if ($grant_id === null || (is_array($grant_id) && count($grant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $grant_id when calling removeGrantFromDevice'
            );
        }
     ...
     * @return void
     */
    public function replaceDevice($device_id, $avalara_version = null, $x_correlation_id = null, $if_match = null, $device = null)
    {
        $this->replaceDeviceWithHttpInfo($device_id, $avalara_version, $x_correlation_id, $if_match, $device);
    }

    /**
     * Operation replaceDeviceWithHttpInfo
     *
     * Update all fields on a device.
     *
     * @param  string $device_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replaceDeviceAsync($device_id, $avalara_version = null, $x_correlation_id = null, $if_match = null, $device = null)
    {
        return $this->replaceDeviceAsyncWithHttpInfo($device_id, $avalara_version, $x_correlation_id, $if_match, $device)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation replaceDeviceAsyncWithHttpInfo
     *
     * Update all fields on a device.
     *
     * @param  string $device_id (required)
    ...
    /**
     * Create request for operation 'replaceDevice'
     *
     * @param  string $device_id (required)
     * @param  string $avalara_version States the version of the API to use. (optional)
     * @param  string $x_correlation_id Correlation ID to pass into the method. Returned in any response. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function replaceDeviceRequest($device_id, $avalara_version = null, $x_correlation_id = null, $if_match = null, $device = null)
    {
        //OAuth2 Scopes
        $requiredScopes = "iam avatax_api";
        // verify the required parameter 'device_id' is set
        if ($device_id === null || (is_array($device_id) && count($device_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $device_id when calling replaceDevice'
            );
        }
