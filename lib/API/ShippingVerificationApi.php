...
/**
 * ShippingVerificationApi Class Doc Comment
 *
 * @category Class
 * @package  Avalara\ASV
 * @author   jonathan.wenger@avalara.com
...
class ShippingVerificationApi
{
            ...
            switch ($e->getCode()) {
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Avalara\ASV\Model\ErrorDetails',
     ...
     * @throws \Avalara\ASV\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Avalara\ASV\Model\ShippingVerifyResult|\Avalara\ASV\Model\ErrorDetails
     */
     ...
     * @throws \Avalara\ASV\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Avalara\ASV\Model\ShippingVerifyResult|\Avalara\ASV\Model\ErrorDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function registerShipmentIfCompliantWithHttpInfo($company_code, $transaction_code, $document_type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Avalara\ASV\Model\ShippingVerifyResult' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Avalara\ASV\Model\ShippingVerifyResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\Avalara\ASV\Model\ErrorDetails' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Avalara\ASV\Model\ErrorDetails', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Avalara\ASV\Model\ShippingVerifyResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Avalara\ASV\Model\ShippingVerifyResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
