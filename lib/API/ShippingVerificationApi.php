...
class ShippingVerificationApi
{
    ...
    public function deregisterShipmentRequest($company_code, $transaction_code, $document_type = null)
    {
        ...
        $clientId="{$this->client->config->getAppName()}; {$this->client->config->getAppVersion()}; PhpRestClient; 2.4.27; {$this->client->config->getMachineName()}";
