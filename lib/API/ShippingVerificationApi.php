...
class ShippingVerificationApi
{
    ...
    private function setConfiguration($client): void
    {
        ...
        $client->setSdkVersion("2.4.14-beta");
    ...
    public function deregisterShipmentRequest($company_code, $transaction_code, $document_type = null)
    {
        ...
        $clientId="{$this->client->config->getAppName()}; {$this->client->config->getAppVersion()}; PhpRestClient; 2.4.14-beta; {$this->client->config->getMachineName()}";
