...
class AgeVerificationApi
{
     ...
     *
     * @param  \Avalara\SDK\Model\AgeVerification\AgeVerifyRequest $age_verify_request Information about the individual whose age is being verified. (required)
     * @param  \Avalara\SDK\Model\AgeVerification\AgeVerifyFailureCode $simulated_failure_code (Optional) The failure code included in the simulated response of the endpoint. Note that this endpoint is only available in Sandbox for testing purposes. (optional)
     *
     * @throws \Avalara\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Avalara\SDK\Model\AgeVerification\AgeVerifyResult
     */
    ...
    public function verifyAgeWithHttpInfo($age_verify_request, $simulated_failure_code = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Avalara\SDK\Model\AgeVerification\AgeVerifyResult' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Avalara\SDK\Model\AgeVerification\AgeVerifyResult', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Avalara\SDK\Model\AgeVerification\AgeVerifyResult',
    ...
    public function verifyAgeRequest($age_verify_request, $simulated_failure_code = null)
    {
        ...
        $clientId="{$this->client->config->getAppName()}; {$this->client->config->getAppVersion()}; PhpRestClient; 2.4.30; {$this->client->config->getMachineName()}";
